...
Background: calendars have been added to the database
    ...
    |name           |api-key |visib  | fee_required |disabled|
...
Scenario: able to read calendar
    ...
    Then I should see the calendar "calendar2" with the values for the following: calendar2,123,public,fee_required_checked
